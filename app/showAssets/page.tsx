...
export default function ShowAssets() {
    const [loading, setLoading] = useState(true); // Initially set to true for loading simulation
                ...
                <div className='p-10 min-h-screen flex flex-col gap-12 items-center'>
                    ...
                    <div className="w-full">
                        {safeWallets.map((safe, index) => (
                            <div key={index} className="w-full p-8 bg-lightGreen rounded-xl flex gap-4 items-center justify-between">
